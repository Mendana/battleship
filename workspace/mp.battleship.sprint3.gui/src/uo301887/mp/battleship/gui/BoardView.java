...
import uo301887.mp.battleship.gui.resources.Icons;
import uo301887.mp.battleship.gui.swing.OnSwingThread;
...
/*package*/ class BoardView extends BoardScreen implements Presenter.View {
	...
	public void setPresenter(Presenter presenter) {
		ArgumentChecks.isTrue( presenter != null, "Invalid null presenter" );
		this.presenter = presenter;
	}
	
	public void setInteractor(Interactor interactor) {
		ArgumentChecks.isTrue( interactor != null, "Invalid null presenter" );
