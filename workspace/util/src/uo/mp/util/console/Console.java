...
public final class Console {
	...
	public static void print(final String string) {
		ArgumentChecks.isNotNull(string, "A null String cannot be printed.");
		ArgumentChecks.isNotEmpty(string, "An empty String cannot be printed.");
		ArgumentChecks.isNotBlank(string, "A blank String cannot be printed.");
		System.out.print(string);
	}

	/**
	 * Prints the given message on the standard console output and return. The given message
	 * cannot be null, empty or blank. If any of these three cases occurs, an
	 * IllegalArgumentException is thrown.
	 * 
	 * @param string is the String to print in the standard output. Cannot be null,
	...
	/**
	 * Prints the given message on the error output. The given message
	 * cannot be null, empty or blank. If any of these three cases occurs, an
	 * IllegalArgumentException is thrown.
	 * 
	 * @param string is the String to print in the standard output. Cannot be null,
